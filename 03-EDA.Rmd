...
cols.cor <- cor(data_enc[,2:ncol(data_enc)], use = "pairwise.complete.obs", method = "pearson")
# Pairwise correlation between rows (Qsns)
rows.cor <- cor(data_enc_trans[,c(2:9, 12:20,22:ncol(data_enc_trans))], use = "pairwise.complete.obs", method = "pearson")
